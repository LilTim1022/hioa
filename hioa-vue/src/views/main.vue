		...
		<nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
			<div class="site-navbar__header">
				<h1 class="site-navbar__brand">
					<a class="site-navbar__brand-lg">HiOA Office System</a>
				...
				>
					...
					>
						<template #title>
							...
							<span slot="title">Organise Management</span>
						</template>
						<el-menu-item
							index="dept"
					...
					>
						<template #title>
							...
							<span slot="title">Automation Office</span>
						</template>
						<el-menu-item
							index="approval"
					...
					>
						...
						>
							<SvgIcon name="warehouse_fill" class="icon-svg" />
							<span slot="title">Meeting Room</span>
						</el-menu-item>
						<el-menu-item
							index="demo-echarts"
						...
						>
							...
							<span slot="title">Offline Meeting</span>
						</el-menu-item>
						<el-menu-item
							index="demo-echarts"
					...
					>
						...
						>
							...
							<span slot="title">Fine Type</span>
						</el-menu-item>
					</el-submenu>
				</el-menu>
			</div>
