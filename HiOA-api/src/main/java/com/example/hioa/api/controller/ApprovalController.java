...
import com.example.hioa.api.controller.form.ApprovalTaskForm;
import com.example.hioa.api.controller.form.ArchiveTaskForm;
import com.example.hioa.api.controller.form.SearchApprovalContentForm;
import com.example.hioa.api.controller.form.SearchTaskByPageForm;
import com.example.hioa.api.exception.HioaException;
import com.example.hioa.api.service.ApprovalService;
    ...
    public void searchApprovalBpmn(String instanceId, HttpServletResponse response) {
        ...
        if(resp.getStatus()==200) {
            ...
            try(
                ...
                throw new HioaException("获取工作流BPMN失败");
            }
        }
    }
